...
/**
    EQ paramétrico de 4 bandas (Low Cut + Low Shelf + Peak/Bell + High Shelf),
    processado antes do compressor. Uma instância por canal de áudio.
*/
class VoiceEQ
{
public:
...
private:
    ...
    juce::dsp::IIR::Filter<float> lowCut, lowShelf, peak, highShelf;
};
